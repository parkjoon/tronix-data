						...
						<div className="cell-sm-6 cell-xs-10 cell-md-4 offset-top-75 offset-md-top-0">
							<div className="unit unit-horizontal">
								...
								<div className="unit-body">
									...
									<div className="offset-top-10">
										<p className="small">Cloud Integrated Storage (CIS) may not fit for every company. Tronix Data has tools to identify the right use cases for CIS and has successfully deployed CIS appliances to leverage Azure, Amazon, and Google cloud migrations.</p>
									</div>
								</div>
							</div>
						</div>
