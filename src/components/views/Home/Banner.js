							...
							<div className="range">
								<div className="range range-xs-center range-md-left range-xs-middle section-cover section-90 text-md-left">
									<div className="cell-xs-10 cell-md-8" style={{paddingBottom: '15em'}}>
										...
										<p data-animation="fadeInUp" data-delay="0.5" data-duration="1" className="animateItem" style={{pointerEvents: 'none'}}>We leverage your data to unlock the true potential of your business.</p>
